...
/**
 * uses fetch to randomly grab 12 users for the page
...
function getUsers() {
  fetch("https://randomuser.me/api/?results=12&nat=gb,us,nz,au")
    ...
    .catch((err) => {
      ...
      gallery.innerHTML = "<h3>There was an error receiving the users!</h3>";
    });
}
...
function createModal(item, data, index) {
  ...
  const html = `<div class="modal">
                    ...
                    <div class="modal-info-container">
                        ...
                        <p class="modal-text cap">Address: ${item.location.city}, ${item.location.state} ${item.location.postcode}</p>
